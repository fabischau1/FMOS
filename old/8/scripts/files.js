    ...
    if (selectedFile.endsWith('.fsys')) {
      ...
      if (confirm('Are you sure you want to delete this file?')) {
		...
		function executeHTML() {
			if (selectedFile && selectedFile.endsWith('.html') || selectedFile.endsWith('.png') || selectedFile.endsWith('.url')) {
		...
		function executeJS() {
		    ...
		    } else if (selectedFile && selectedFile.endsWith('.html') || selectedFile.endsWith('.png') || selectedFile.endsWith('.url')) {
		        executeHTML();
		    } else {
